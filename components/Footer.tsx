...
const Footer: React.FC<FooterProps> = ({ onNavigate }) => {
  ...
  return (
    <footer className="bg-slate-950 border-t border-white/10 pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 md:px-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div>
          <div className="flex items-center space-x-3 mb-6">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[10px] text-blue-400 font-medium tracking-widest uppercase">Training Center</span>
            </div>
          </div>
        ...
        <div>
          ...
          <p className="text-gray-400 text-sm mb-4">
            <span className="block text-blue-400 font-medium mb-1 uppercase text-xs tracking-wider">Phone Number</span>
            +27 68 917 6294
          </p>
          <p className="text-gray-400 text-sm">
            <span className="block text-blue-400 font-medium mb-1 uppercase text-xs tracking-wider flex items-center">
      ...
      {/* Copyright */}
      <div className="max-w-7xl mx-auto px-4 md:px-8 mt-16 pt-8 border-t border-white/5 text-center">
        <p className="text-gray-500 text-xs">
          © {new Date().getFullYear()} Bathudi Training Center. All rights reserved. Professional Automotive Training.
        </p>
      </div>
    </footer>
  );
